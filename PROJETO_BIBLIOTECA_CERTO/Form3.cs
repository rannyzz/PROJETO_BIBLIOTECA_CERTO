...
namespace PROJETO_BIBLIOTECA_CERTO
{
    ...
    {
        string nomeLogado = "";
        public Form3(string nomeUsuario)
        {
            InitializeComponent();
            this.FormClosed += Form3_FormClosed;
            lbl_ola.Text = $"Olá, {nomeUsuario}!";
        }
        string MySqlClient = "Server = localhost; Port = 3306; User = root; Database = bdcadastro; SslMode = Disabled";
        ...
        private void btn_deletar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MySqlConnection conn = new MySqlConnection(MySqlClient);
                conn.Open();
                string sql = "DELETE FROM tbcadastro WHERE ID = @id";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@id", txt_id.Text); // evita SQL injection
                cmd.ExecuteNonQuery();
                MessageBox.Show("Cadastro deletado com sucesso!", "Alerta",
        ...
        private void btn_listar_MouseHover(object sender, EventArgs e)
        {
        ...
        private void lbl_igor_Click(object sender, EventArgs e)
        {
